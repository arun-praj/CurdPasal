...
const CartDetails = (props) => {
   const { loading, count, cartProducts } = props;
   // cartProducts && cartProducts.products.map((el) => console.log(el));
   // console.log(count);

   return (
      <section className='section__cart__details'>
         <div className='cart__details__header'>
            <Wrapper style={{ height: "100%" }}>
               <div className='cart__details__header__container'>
         ...
         <Wrapper style={{ minHeight: "75vh" }}>
            <div className='cart__details__body'>
               {loading ? (
                  <div>Loading</div>
               ) : (
                  <>
                                    ...
                                    <div key={el._id} className='cart__details__body__box'>
                                       ...
                                       <div>
                                          <div
                                             ...
                                             className='cart__details__body__box--heading'>
                                             {el.name}
                                          </div>
                                          <div
                                             style={{
                                             ...
                                             elit. Laudantium repudiandae necessitatibus odit nisi
                                             earum debitis quas similique, vitae qui molestiae!
                                          </div>
                                       </div>
                                       <div
                                          style={{
                                       ...
                                       <div
                                          ...
                                          <span style={{ color: "red", fontWeight: "700" }}>
                                             <svg color='red' width='13' height='13'>
                                                <use xlinkHref='/icons/tabler-sprite.svg#tabler-currency-rupee' />
                                             </svg>
                                             {el.price}
                                          </span>
                                       </div>
                     ...
                     {props.cartEmpty ? null : (
                        <div className='grid-2'>
                           <div className='checkout__box' style={{ width: "270px" }}>
                              <span style={{ fontSize: "18px", color: "#686f7a" }}>Total:</span>
                              <div
                                 style={{
                                    fontSize: "36px",
                                    display: "flex",
                              ...
                              <Button
                                 type='primary'
                                 value='Checkout'
                                 style={{ height: "54px", fontWeight: "700" }}
                              />
                           </div>
                        </div>
                     )}
...
const mapStateToProps = (state) => {
   return {
      count: state.userCart.cart.count,
